...
# Cree un método llamado redimensionar(...) dentro de la clase HashMap que reciba un parametro 'n' y que redimensione el arreglo de buckets de tal forma que quede de tamaño 'n' y redistribuya los elementos existentes dentro del HashMap en el nuevo arreglo de buckets. Incluya todo el código de la declaración de las clases HashMap (HM), NodoMapeo (NM) y un ejemplo del funcionamiento del método.
...
# Añada un método llamado vaciar(...) en la clase HashMap que elimine todos los pares clave-valor del HashMap, dejando el HashMap vacío. Incluya todo el código de la declaración de las clases HashMap (HM), NodoMapeo (NM) y un ejemplo del funcionamiento del método.
