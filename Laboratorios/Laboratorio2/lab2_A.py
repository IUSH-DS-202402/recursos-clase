...
# Cree un método llamado eliminarDesde(...) dentro de la clase Lista Simplemente Enlazada (LSL) que reciba un índice n como parámetro y elimine todos los nodos a partir del n-ésimo elemento contado desde el FINAL de la lista hacia el principio. Incluya todo el código de la declaración de la clase LSL y un ejemplo del funcionamiento del método.
...
# Cree un método llamado eliminaMenoresA(...) dentro de la clase Lista Simplemente Enlazada (LSL) que elimine los nodos cuyo dato sea menor al ingresado. Incluya todo el código de la declaración de la clase LSL y un ejemplo del funcionamiento del método.
