...
2. **Archivos del Laboratorio**:
   - Para este laboratorio solo está disponible el archivo `lab7_A`.
...
1. **Formato y Nombre del Archivo**:
   ...
   - Es crucial que **conserves el nombre original** del archivo (`lab7_A` ).
...
4. **Fecha máxima de envío:**:
   - 07 de Noviembre del 2024 a las 23:59:59 PM
